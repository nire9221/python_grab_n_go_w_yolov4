...
def draw_bbox(image, bboxes, info = False, show_label=True, counted_classes = None, classes=read_class_names(cfg.YOLO.CLASSES)):
    ...
    for i in range(num_boxes):
        ...
        #remove the label that class name is person
