...
import DBConn as db
import copy
from pose_estimation import skeleton_visualizer
import collections
...
############### box format ###############  
        ...
        # allowed_classes = ['person','cup','bottle','cell phone']
        ...
        for track in tracker.tracks:
            ...
            # counted_classes = count_objects(pred_bbox, by_class = False, allowed_classes=class_name)
            ...
            for p in person_list:
                for i in item_list:
                    ...
                    if cal_distance(person_list,item_list) < 300.0 : 
                        ...
                        #     # print ('track_cart', track_cart)
                        #     cart_list=cart_list.append(cart_detail)
                            
                            
                        #         # key = track.class_name
                        #     cart_detail = {'item' :track.class_name, 'qty':counted_classes}
                        #     # cart_detail = collections.Counter(cart_detail)
                        ...
                        #     print('cart_detail', cart_detail)
                            ...
                            # cv2.putText(frame, "customer {} 's cart - {} : {}".format(track_cart['user id'],cart_detail['item'],cart_detail['qty']), (5, 35+idx), cv2.FONT_HERSHEY_COMPLEX_SMALL, 1, (255,0, 0), 1)
                        ...
                        # cv2.putText(frame, "{} 's cart - {} : {}".format(track.track_id, class_name, count+1), (5, 35+idx), cv2.FONT_HERSHEY_COMPLEX_SMALL, 1, (255,0, 0), 1)
                        # idx+=18
                    # cart_list.append(cart_detail)    
            # print ('track_cart', track_cart)    
